...
class MainWin(tk.Frame):
    ...
    def __init__(self, master):
        ...
        master.geometry(set_size(master, 490, 450))
        ...
        self.file.add_command(label = 'Sozlamalar', command =self.settings)
        ...
        self.bcode_val = ttk.Entry(self.frameTopLeft, width=16, textvariable=self.bcvalue, font=('Arial', 15))
        ...
        self.bcode_comment = tkst.ScrolledText(self.textFrame, wrap=tk.WORD, width=23, height=3, font=('Arial', 10))
        ...
        # Preview
        self.imagepanel = tk.Canvas(self.frameTopRight, width=250, height=180);
        ...
        self.tree.column("#0",minwidth=20, width=50, stretch=True, anchor="center")
        self.tree.column("barcodes",minwidth=50, width=85, stretch=True, anchor="center")
        self.tree.column("type",minwidth=40, width=65, stretch=True, anchor="center")
        self.tree.column("comment",minwidth=120, width=245, stretch=True, anchor="center")
